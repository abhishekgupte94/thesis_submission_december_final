...
def spec_extraction(file_name,win_size):
    ...
    x_train_mean = np.load('/Users/abhishekgupte_macbookpro/PycharmProjects/melodyExtraction_JDC/x_data_mean_total_31.npy')
    x_train_std = np.load('/Users/abhishekgupte_macbookpro/PycharmProjects/melodyExtraction_JDC/x_data_std_total_31.npy')
