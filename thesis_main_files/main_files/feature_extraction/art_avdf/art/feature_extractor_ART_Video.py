...
class SWIN_EXECUTOR:
    def __init__(self,video_preprocess_dir = None):
        ...
        self.text_file = str(Path(video_preprocess_dir) / "sample.txt")
        # Assuming project_dir_video_swin is still a Path object
...
sv_path, video_preprocess_dir, feature_dir_vid, video_dir, real_output_txt_path = convert_paths()
sw = SWIN_EXECUTOR(video_preprocess_dir = video_preprocess_dir)

features_out = sw.execute_swin(return_output = True)
