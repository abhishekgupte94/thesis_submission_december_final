...
#     t_sne_save_path = str(project_dir_curr / "images" / "dfdc" / "evaluation_results" / "art"/"t_sne_evaluation.png")
#     retrieval_save_path = str(project_dir_curr / "images" / "dfdc" / "evaluation_results" / "art"/"retrieval_evaluation.png")
...
#     audio_preprocess_dir = str(project_dir_curr / "datasets" / "processed" / "dfdc" / "features" / "audio" / "real")
#     feature_dir_audio = str(project_dir_curr / "datasets" / "processed" / "dfdc" / "features" / "audio" / "real")
#
...
def create_file_paths(project_dir_curr, csv_name="training_data_dfdc.csv"):
    """
...
class VideoAudioFeatureExtractor:
    ...
    def extract_audio_features(self, audio_preprocessor, video_paths, batch_size):
        try:
...
class VideoAudioFeatureProcessor:
    ...
    """
    def __init__(self, video_preprocess_dir, feature_dir_vid, batch_size, video_save_dir, output_txt_file):
        self.video_preprocess_dir = video_preprocess_dir
        self.feature_dir_vid = feature_dir_vid
    ...
    def create_datasubset(self, csv_path, use_preprocessed=True, video_paths=None, video_save_dir=None, output_txt_file=None):
        processed_video_features = None
        processed_audio_features = None
        video_error = False
        audio_error = False
        ...
        if not video_error and not audio_error:
            return processed_audio_features, processed_video_features
        else:
            print("Errors encountered. No features returned.")
            return None, None
...
class VideoAudioDataset(Dataset):
    ...
    def __init__(self, project_dir_curr, csv_name="training_data_two.csv", augmentations=None):
        ...
        self.video_paths, self.labels = create_file_paths(project_dir_curr, csv_name)
