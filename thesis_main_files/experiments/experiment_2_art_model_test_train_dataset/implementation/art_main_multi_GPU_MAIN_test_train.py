...
##USE CSV - training_data_three.csv ONLY
import os
import sys
# import os
...
def main():
    ...
    parser.add_argument('--csv_file', type=str, default="training_data_three.csv", help='CSV filename for training or preprocessing')
