...
if __name__ == "__main__":
    transcripts_csv_path = "/data/processed_files/csv/lav_df/transcripts/transcripts.csv"

    updated_transcripts_csv_path = "/data/processed_files/csv/lav_df/transcripts/audio_against_transcripts.csv"
