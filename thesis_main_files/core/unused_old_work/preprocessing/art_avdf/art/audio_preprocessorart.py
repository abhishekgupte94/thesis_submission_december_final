...
class AudioPreprocessor:
    ...
    def process_batch(self, audio_paths):
        for audio_path in audio_paths:
            full_audio_path = os.path.join(self.project_dir, "data", "processed_files", "lav_df", "audio_wav", "train", audio_path)
    ...
    def process(self, audio_paths, batch_size=32):
        ...
        for i in range(0, len(audio_paths), batch_size):
            ...
            full_audio_paths = [
                os.path.join(self.project_dir, "data", "processed_files", "lav_df", "audio_wav", "train", audio_path)
...
#     csv_path = str(
#         project_dir_curr / "data" / "processed_files" / "csv" / "lav_df" / "inference_data" / "training_data_two.csv")
#     # Audio preprocess path
#     audio_dir = str(project_dir_curr / "data" / "processed_files" / "lav_df" / "audio_wav" / "train")
#     video_dir = str(project_dir_curr / "data" / "processed_files" / "lav_df" /  "train")
#     audio_preprocess_dir = str(project_dir_curr / "data" / "processed_files" / "lav_df" / "features" / "audio" / "real")
#     feature_dir_audio = str(project_dir_curr / "data" / "processed_files" / "lav_df" / "features" / "audio" / "real")
