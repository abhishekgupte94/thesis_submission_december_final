...
from thesis_main_files.main_files.unused_old_work.feature_extraction import MViTVideoFeatureExtractor

device = torch.device("cuda:0") if torch.cuda.is_available() else torch.device("cpu")
use_amp = torch.cuda.is_available()

# 1) init adapter (it builds the train extractor inside)
...
video_dir = "/thesis_main_files/core/feature_extraction/unused_old_work/Audio_Feature_Extraction/ast_huggingface/video_dir_test"
