...
def fake_real_classification_test(features, labels, filenames):
    ...
    if len(labels_clean) <= 6:
        ...
        # Original cross-validation approach for larger data
        classifiers = {
        ...
        results = {}
        cv_folds = min(min_class_size, 3)  # Use fewer folds for small data
