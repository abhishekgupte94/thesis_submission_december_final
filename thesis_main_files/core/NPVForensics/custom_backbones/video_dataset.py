...
class VideoDataSet(data.Dataset):
    ...
    def __init__(self, root_path, list_file, num_groups=64, frames_per_group=1, sample_offset=0, num_clips=1,
        ...
        Args:
            ...
            fixed_offset (bool): used for generating the same video used in TSM
    ...
    def _parse_list(self):
        ...
        num = len(tmp)
        print("The number of video is {} (with more than {} frames) "
    ...
    def remove_data(self, idx):
        ...
        print("Original video: {}\t remove {} video, remaining {} video".format(original_video_num, len(idx), len(self.video_list)))
...
class VideoDataSetLMDB(data.Dataset):
    ...
    def remove_data(self, idx):
        ...
        self.length -= len(idx)
        print("Original video: {}\t remove {} video, remaining {} video".format(original_video_num, len(idx), self.length))
