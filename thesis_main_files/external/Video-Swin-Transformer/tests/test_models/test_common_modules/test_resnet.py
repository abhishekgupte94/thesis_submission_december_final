...
def test_resnet_backbone():
    ...
    # resnet with depth 18 evaluation_for_detection_model
    ...
    # resnet with depth 50 evaluation_for_detection_model
    ...
    # resnet with depth 50 in caffe style evaluation_for_detection_model
