...
def test_resnet3d_backbone():
    ...
    # resnet3d frozen with depth 34 evaluation_for_detection_model
    ...
    # resnet3d with depth 50 evaluation_for_detection_model
    input_shape = (1, 3, 6, 64, 64)
    imgs = generate_backbone_demo_inputs(input_shape)
    # parrots 3dconv is only implemented on gpu
    if torch.__version__ == 'parrots':
    ...
    # resnet3d with depth 50 in caffe style evaluation_for_detection_model
    ...
    # resnet3d with depth 34 in caffe style evaluation_for_detection_model
    ...
    # resnet3d with depth with 3x3x3 inflate_style evaluation_for_detection_model
