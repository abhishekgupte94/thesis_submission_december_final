...
def test_x3d_backbone():
    ...
    # x3d_s evaluation_for_detection_model
    ...
    # x3d_m evaluation_for_detection_model
...
def test_slowfast_backbone():
    ...
    # slowfast w/o lateral connection evaluation_for_detection_model test
    input_shape = (1, 3, 8, 64, 64)
    imgs = generate_backbone_demo_inputs(input_shape)
    # parrots 3dconv is only implemented on gpu
    if torch.__version__ == 'parrots':
    ...
    # slowfast evaluation_for_detection_model test
    input_shape = (1, 3, 8, 64, 64)
    imgs = generate_backbone_demo_inputs(input_shape)
    # parrots 3dconv is only implemented on gpu
    if torch.__version__ == 'parrots':
...
def test_slowonly_backbone():
    ...
    # SlowOnly evaluation_for_detection_model test
    input_shape = (1, 3, 8, 64, 64)
    imgs = generate_backbone_demo_inputs(input_shape)
    # parrots 3dconv is only implemented on gpu
    if torch.__version__ == 'parrots':
...
def test_c3d_backbone():
    ...
    # c3d evaluation_for_detection_model test
    c3d = C3D()
    c3d.init_weights()
    c3d.train()
    feat = c3d(imgs)
    ...
    # c3d with bn evaluation_for_detection_model test
...
def test_resnet_audio_backbone():
    ...
    # evaluation_for_detection_model
...
def test_resnet_tin_backbone():
    ...
    # resnet_tin with normal cfg evaluation_for_detection_model
